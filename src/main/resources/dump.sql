...
insert into users(id, user_name, first_name, second_name, email, password) values(1, 'kichenko', 'Сергей', 'Киченко', 'kichenko@mail.ru', '$2a$10$/87PU/Hi1fbatIyD8974Put1DfpfaHGjvwNLSPAy7YIyTXtq3yOjm');
insert into user_roles(user_id, role_id) values(1, 1);

insert into users(id, user_name, first_name, second_name, email, password) values(2, 'ivanov', 'Иван', 'Иванов', 'ivanov@mail.ru', '$2a$10$/87PU/Hi1fbatIyD8974Put1DfpfaHGjvwNLSPAy7YIyTXtq3yOjm');
